"""
logging_config.py - Logging setup with file rotation and separate log files.
"""
...
def setup_logging() -> logging.Logger:
    ...
    Creates log files in the configured LOG_DIR.
    """
    ...
    # Optional: separate download and upload loggers
