...
BOT_USERNAME      = os.getenv("BOT_USERNAME", "appx_v2_3_bot")
...
# AppX V2 video CDN (requires Bearer token on EVERY request — no public URL)
APPX_V2_TRANS_CDN = "https://static-trans-v2.appx.co.in"
...
YTDLP_CONCURRENCY   = int(os.getenv("YTDLP_CONCURRENCY", "4"))   # safe for AppX CDN
...
MAX_PARALLEL_DL      = int(os.getenv("MAX_PARALLEL_DL", "1"))
