"""
AppX Uploader Bot v4.3 — FIXED main entry point.
...
v4.3 fix: AppX V2 encrypted video now properly routes through yt-dlp
with Bearer-token headers. No more broken bypass links for V2 content.
"""
...
from config.settings import API_ENABLED, BOT_TOKEN, BOT_VERSION, DB_PATH, TEMP_DIR
...
USER_COMMANDS = [
    ...
    BotCommand("cookie",   "Set AppX cookie (Bearer token)"),
...
async def main() -> None:
    ...
    logger.info("🚀 %s v%s starting…", cfg.BOT_NAME, BOT_VERSION)
